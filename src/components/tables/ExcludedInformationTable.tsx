...
import { IExcludedInformation } from "@/types/ExcludedInformation";
import { useQuery } from "@tanstack/react-query";
import { useState } from "react";
import ModalFormExcludedInformation from "../modal/ModalFormExcludedInformation";
import {
  Table,
  TableBody,
  TableCell,
...
export default function ExcludedInformationTable() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useQuery<IExcludedInformation[]>({
    queryKey: ["excludedInformation", currentPage],
    queryFn: async () => {
      const response = await apiV1.get("/excluded-information", {
  ...
  function showModal(act: any, id: any, itemList?: IExcludedInformation[]) {
    setAction(act);
    setInfoId(id);
